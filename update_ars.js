...
// Players to remove from their old clubs (or current ars for outbounds)
const removals = [
...
// Now insert the new players into ars
// Let's insert them right after Martin Zubimendi or just Declan Rice
